---
title: Home
description: Icall26Sign aims to be the world's most trusted document-signing tool. Join us in creating the next generation of open trust infrastructure.
---
...
<Wrapper>
  ...
  <div className="flex flex-col items-center mb-16">
    ...
    <span className="text-muted-foreground mx-auto mt-4 max-w-2xl text-center leading-normal tracking-tight">Icall26Sign aims to be the world's most trusted document-signing tool. Join us in creating the next generation of open trust infrastructure.</span>
