...
description: Learn about the different fields you can add to your documents in Icall26Sign.
---

# Document Fields

Learn about the different fields you can add to your documents in Icall26Sign and how to make the most of them.
...
![The signature field in the Icall26Sign document editor](/document-signing/signature-field-document-editor-view.webp)
...
![The signature field in the Icall26Sign document signing view](/document-signing/signature-field-document-signing-view.webp)

The image below shows the signature field signed by the recipient.

![The signature field signed by the user in the Icall26Sign document signing view](/document-signing/signed-signature-field.webp)
...
![The email field in the Icall26Sign document editor](/document-signing/email-field-document-editor-view.webp)
...
![The email field in the Icall26Sign document signing view](/document-signing/email-field-document-signing-view.webp)

The image below shows the email field signed by the recipient.

![The email field signed by the user in the Icall26Sign document signing view](/document-signing/signed-email-field.webp)
...
![The name field in the Icall26Sign document editor](/document-signing/name-field-document-editor-view.webp)
...
![The name field in the Icall26Sign document signing view](/document-signing/name-field-document-signing-view.webp)

The image below shows the name field signed by the recipient.

![The name field signed by the user in the Icall26Sign document signing view](/document-signing/name-field-signed.webp)
...
![The date field in the Icall26Sign document editor](/document-signing/date-field-document-editor-view.webp)
...
![The date field in the Icall26Sign document signing view](/document-signing/date-field-document-signing-view.webp)

The image below shows the date field signed by the recipient.

![The date field signed by the user in the Icall26Sign document signing view](/document-signing/date-field-signed.webp)
...
![The text field in the Icall26Sign document editor](/document-signing/text-field-document-editor-view.webp)
...
![The text field settings in the Icall26Sign document editor](/document-signing/text-field-advanced-settings-document-editor-view.webp)
...
![A text field with the settings configured by the user in the Icall26Sign document editor](/document-signing/text-field-with-filled-advanced-settings.webp)
...
![Text field with the default value signed by the user in the Icall26Sign document signing view](/document-signing/text-field-autosigned.webp)
...
![Unsigned text field in the Icall26Sign document signing view](/document-signing/text-field-unsigned.webp)

To sign the field with a different value, the recipient needs to click on the field and enter the new value.

![Text field with the text input in the Icall26Sign document signing view](/document-signing/text-field-input-modal.webp)
...
![The number field in the Icall26Sign document editor](/document-signing/number-field-document-editor.webp)
...
![The number field in the Icall26Sign document editor](/document-signing/number-field-document-editor-view.webp)
...
![A number field with the label configured by the user in the Icall26Sign document editor](/document-signing/number-field-label.webp)
...
![Number field with the default value signed by the user in the Icall26Sign document signing view](/document-signing/number-field-autosigned.webp)
...
![Unsigned number field in the Icall26Sign document signing view](/document-signing/number-field-unsigned.webp)

To sign the field with a different value, the recipient needs to click on the field and enter the new value.

![Number field with the number input in the Icall26Sign document signing view](/document-signing/number-field-input-modal.webp)
...
![The radio field in the Icall26Sign document editor](/document-signing/radio-field-document-editor-view.webp)
...
![The radio field advanced settings in the Icall26Sign document editor](/document-signing/radio-field-advanced-settings-document-editor-view.webp)
...
![The radio field with the settings configured by the user in the Icall26Sign document editor](/document-signing/radio-field-options-document-editor-view.webp)
...
![Radio field with no value selected in the Icall26Sign document signing view](/document-signing/radio-field-unsigned.webp)

The recipient can select one of the options by clicking on the radio button next to the option.

![Radio field with the value selected by the user in the Icall26Sign document signing view](/document-signing/radio-field-signed.webp)
...
![The checkbox field in the Icall26Sign document editor](/document-signing/checkbox-document-editor-view.webp)
...
![The checkbox field settings in the Icall26Sign document editor](/document-signing/checkbox-advanced-settings.webp)
...
![The checkbox field with the settings configured by the user in the Icall26Sign document editor](/document-signing/checkbox-advanced-settings-document-editor-view.webp)
...
![Checkbox field with the values selected by the user in the Icall26Sign document signing view](/document-signing/checkbox-field-document-signing-view.webp)
...
![Checkbox field the values cleared by the user in the Icall26Sign document signing view](/document-signing/checkbox-field-unsigned.webp)

Then, the recipient can select values other than the ones chosen by the sender.

![Checkbox field with the values selected by the user in the Icall26Sign document signing view](/document-signing/checkbox-field-custom-sign.webp)
...
![The dropdown/select field in the Icall26Sign document editor](/document-signing/select-field-sliders.webp)
...
![The dropdown/select field settings in the Icall26Sign document editor](/document-signing/select-field-advanced-settings-panel.webp)
...
![Dropdown/select field  in the Icall26Sign document signing view](/document-signing/select-field-unsigned.webp)
...
![Dropdown/select field with the dropdown list in the Icall26Sign document signing view](/document-signing/select-field-unsigned-dropdown.webp)
