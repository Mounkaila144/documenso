...
Icall26Sign allows you to create templates, which are reusable documents. Templates are helpful if you often send the same type of document, such as contracts, agreements, or invoices, as they help you save time.
...
![Icall26Sign template page](/templates/documenso-template-page.webp)

Clicking on the "New Template" button opens a new modal to upload the document you want to use as a template. Select the document and wait for Icall26Sign to upload it to your account.

![Upload a new template document in the Icall26Sign dashboard](/templates/documenso-template-page-upload-document.webp)

Once the upload is complete, Icall26Sign opens the template configuration page.

![A successfuly uploaded document in the Icall26Sign dashboard](/templates/documenso-template-page-uploaded-document.webp)

You can then configure the template by adding recipients, fields, and other options.

### (Optional) Email options

When you send a document for signing, Icall26Sign emails the recipients with a link to the document. The email contains a subject, message, and the document.

Icall26Sign uses a generic subject and message but also allows you to customize them for each document and template.

![Configuring the email options for the Icall26Sign template](/templates/documenso-template-page-uploaded-document-email-options.webp)

To configure the email options, click the "Email Options" tab and fill in the subject and message fields. Every time you use this template for signing, Icall26Sign will use the custom subject and message you provided. They can also be overridden before sending the document.
...
![Configuring the advanced options for the Icall26Sign template](/templates/documenso-template-page-uploaded-document-advanced-options.webp)
...
![Adding placeholder recipients for the Icall26Sign template](/templates/documenso-template-recipients.webp)
...
Icall26Sign provides the following field types:
...
![Adding fields for the Icall26Sign template](/templates/documenso-template-page-fields.webp)
...
![Use an available Icall26Sign template](/templates/documenso-use-template.webp)
