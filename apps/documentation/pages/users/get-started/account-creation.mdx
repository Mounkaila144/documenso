...
description: Learn how to create an account on Icall26Sign.
---
...
The first step to start using Icall26Sign is to pick a plan and create an account. At the moment of writing this guide, we have 3 plans available: Free, Individual, and Teams.
