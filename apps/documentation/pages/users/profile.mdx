---
title: User Profile
description: Learn how to set up your public profile on Icall26Sign.
---
...
Icall26Sign allows you to create a public profile to share your templates for anyone to sign. This is useful for distributing and collecting signatures for commonly used documents, making it more efficient for both the document creator and the signers.

<Callout type="info">A free Icall26Sign account gives you 5 free signatures per month.</Callout>
...
![An example of a public profile on Icall26Sign](/direct-links/documenso-profile.webp)

The image above shows an example of a public profile on Icall26Sign.
