---
title: How to Self-Host Icall26Sign
description: Learn how to self-host Icall26Sign on your server or cloud infrastructure using Docker or other deployment methods.
---
...
The following guide will walk you through setting up Icall26Sign manually on your server or cloud infrastructure.
...
<Callout type="info">
  If you use a reverse proxy in front of Icall26Sign, don't forget to provide the public URL for the
...
The following guide will walk you through setting up Icall26Sign using Docker. You can choose between a Docker Compose production setup or a standalone container.

We provide a Docker container for Icall26Sign, published on both DockerHub and GitHub Container Registry.
...
This setup includes a PostgreSQL database and the Icall26Sign application. You will need to provide your own SMTP details using environment variables.

<Steps>

### Download the Docker Compose File

Download the Docker Compose file from the Icall26Sign repository - [compose.yml](https://raw.githubusercontent.com/documenso/documenso/release/docker/production/compose.yml).
...
The command will start the PostgreSQL database and the Icall26Sign application containers.

### Access the Application

Access the Icall26Sign application by visiting `http://localhost:3000` in your web browser.

</Steps>

### Option 2: Standalone Docker Container

If you prefer to host the Icall26Sign application on a specific container provider, use the pre-built Docker image from DockerHub or GitHub's Package Registry. You will need to provide your own database and SMTP host.

<Steps>

### Pull the Docker Image

Pull the Icall26Sign Docker image from DockerHub:
...
You can access the Icall26Sign application by visiting the URL you provided for the `NEXT_PUBLIC_WEBAPP_URL` environment variable in your web browser.

</Steps>

### Advanced Configuration

The environment variables listed above are a subset of those available for configuring Icall26Sign. The table below provides a complete list of environment variables and their descriptions.

| Variable                                     | Description                                                                                         |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| `PORT`                                       | The port on which the Icall26Sign application runs. It defaults to `3000`.                            |
...
We offer several alternative deployment methods for Icall26Sign if you need more options.
