...
description: Versioning information for the Icall26Sign public API.
---
...
Icall26Sign uses API versioning to manage changes to the public API. This allows us to introduce new features, fix bugs, and make other changes without breaking existing integrations.
