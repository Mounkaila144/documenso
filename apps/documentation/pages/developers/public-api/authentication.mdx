...
description: Learn how to create a Icall26Sign API key and authenticate your API requests.
---

# API Authentication

Icall26Sign uses API keys for authentication. An API key is a unique token that is generated for each client. The client must provide the key whenever it makes an API call. This way, Icall26Sign can identify the clients making the requests and authorize their access to the API.
...
![A screenshot of the Icall26Sign's dashboard that shows the dropdown menu when you click on your user avatar](/public-api-images/documenso-user-dropdown-menu.webp)
...
![A screenshot of the Icall26Sign's user settings page that shows the API Tokens page](/public-api-images/api-tokens-page-documenso.webp)
...
![A screenshot of the newly created API token in the Icall26Sign dashboard](/public-api-images/documenso-api-key-blurred.webp)

Once you've created the token, Icall26Sign will display the key on the screen. Make sure to copy the key and store it securely. You won't be able to see the key again once you refresh/leave the page.
...
![A screenshot of a cURL request to the Icall26Sign public API with the API key in the Authorization header](/public-api-images/documenso-api-authorization.webp)
