...
description: Learn how to set up Icall26Sign for local development.
---

# Local development

There are multiple ways of setting up Icall26Sign for local development. At the moment of writing this documentation, there are 3 ways of running Icall26Sign locally:
...
<div className="mt-16 flex items-center justify-center gap-4">
  <a href="https://documen.so/discord">
    <img
      ...
      alt="Join Icall26Sign on Discord"
    />
  </a>
