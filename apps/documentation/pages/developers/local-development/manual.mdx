---
title: Manual Setup
description: Manually set up Icall26Sign on your machine for local development.
---
...
Follow these steps to set up Icall26Sign on your local machine:

<Steps>

### Fork Icall26Sign

Fork the [Icall26Sign repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
