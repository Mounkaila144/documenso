  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using Icall26Sign to perform your electronic document signing. The purpose
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by Icall26Sign, you affirm
